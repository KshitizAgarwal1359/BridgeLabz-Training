...
class SentenceFormatter{
    public static string FormatParagraphText(string inputText){
    ...
    for (int currentPos = 0; currentPos < inputText.Length; currentPos++){
     ...
     // ---------- PARAGRAPH ANALYSIS ----------
    public static void AnalyzeParagraphText(string paragraphText, string targetWord, string replacementWord){
    ...
    public static bool CompareWordsIgnoringCase(char[] wordCharacters, int wordLength, string targetWord){
