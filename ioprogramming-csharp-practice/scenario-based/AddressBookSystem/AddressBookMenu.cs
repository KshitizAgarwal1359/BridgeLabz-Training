            ...
            while (!exit)
            {
                ...
                try
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 12:service.WriteAddressBookToFile();break;
                        case 13:service.ReadAddressBookFromFile();break;
                        case 14:service.WriteAddressBookToCSV();break;
                        case 15:service.ReadAddressBookFromCSV();break;
                        case 16:service.WriteAddressBookToJson();break;
                        case 17:service.ReadAddressBookFromJson();break;
                        case 18: exit = true; Console.WriteLine("Exiting..."); break;
                        default:
